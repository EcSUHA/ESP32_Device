...
SCDERoot_t* SCDERoot_at_ESP32_I2C_Master_M;

// stores SCDEFn (Functions / callbacks) provided for operation - at/for this Module
SCDEFn_t* SCDEFn_at_ESP32_I2C_Master_M;
...
Entry_String_t* ESP32_I2C_Master_Attribute(Common_Definition_t* p_entry_definition, const String_t attr_command, const String_t attr_name, const String_t attr_value);
...
Entry_String_t* ESP32_I2C_Master_Write(Common_Definition_t *Common_Definition, String_t data);
