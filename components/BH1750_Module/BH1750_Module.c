...
#ifndef BH1750_Module_DBG  
#define BH1750_Module_DBG  5	// 5 is default
#endif 
...
// BH1750_SET_SIG_OUT_EN -> 'SIG_OUT_EN' -> Disabled|Enabled
SelectAData BH1750_DisEna[] = {  //ID, Text MAX CGI LEN BEACHTEN!!!
  {0,"Disabled"},
  {1,"Enabled"}, 
  {0, NULL}
  };

// BH1750_SET_IDLE_LV -> 'IDLE_LV' -> Low|High
SelectAData BH1750_LoHi[] = {  //ID, Text MAX CGI LEN BEACHTEN!!!
  {0,"Low"},
  {1,"High"}, 
  {0, NULL}
  };

// BH1750_SET_BLOCK -> 'PWM_BLOCK'-> High_Speed|Low_Speed
SelectAData BH1750_PWM_BLOCK[] = {  //ID, Text MAX CGI LEN BEACHTEN!!!
  {0,"High_Speed"},
  {1,"Low_Speed"},
  {0, NULL}
  };

// BH1750_SET_TICK_SOURCE -> 'TICK_SOURCE'-> REF|APB_SLOW
SelectAData BH1750_TICK_SOURCE[] = {  //ID, Text MAX CGI LEN BEACHTEN!!!
  {0,"REF"},
  {1,"APB_SLOW"}, 
  {0, NULL}
  };
 ...
 * parsed result is stored in BH1750_parsedKVInput_t
 */
enum BH1750_SET_IK {				// Bit #XX for debugging

  // S0 calculation configuration
    BH1750_SET_ON		= 0			// Bit #00 'ON'  -> 
  , BH1750_SET_OFF				// Bit #01 'OFF'  -> 

  , BH1750_SET_MAX				// Bit #02 'MAX'  -> 
  , BH1750_SET_MIN				// Bit #03 'MIN'  -> 

  , BH1750_SET_VAL				// Bit #04 'VAL'  -> 
  , BH1750_SET_DIM				// Bit #05 'DIM'  -> 

  , BH1750_SET_NAME				// Bit #06 'NAME'  -> 
  , BH1750_SET_CAPS				// Bit #07 'CAPS'  -> 

  // Block #01 PWM configuration
  , BH1750_SET_GPIO				// Bit #08 'GPIO' -> 
  , BH1750_SET_BLOCK				// Bit #09 'BLOCK' -> 
  , BH1750_SET_CHANNEL				// Bit #10 'CHANNEL' -> 
  , BH1750_SET_TIMER				// Bit #11 'TIMER' -> 

  , BH1750_SET_DUTY				// Bit #12 'DUTY' ->
  , BH1750_SET_HPOINT				// Bit #13 'HPOINT' ->
  , BH1750_SET_SIG_OUT_EN				// Bit #14 'SIG_OUT_EN' ->
  , BH1750_SET_IDLE_LV				// Bit #15 'IDLE_LV' ->

  , BH1750_SET_RESOLUTION			// Bit #16 'RESOLUTION' -> 
  , BH1750_SET_TICK_SOURCE			// Bit #17 'TICK_SOURCE' ->
  , BH1750_SET_FREQ_HZ				// Bit #18 'FREQ_HZ' ->

  , BH1750_SET_THR_L_LIM_EN			// Bit #19 'THR_L_LIM_EN' -> DIS/ENA
  , BH1750_SET_THR_H_LIM_EN			// Bit #20 'THR_H_LIM_EN' -> DIS/ENA
  , BH1750_SET_THR_ZERO_EN			// Bit #21 'THR_ZERO_EN' -> DIS/ENA
  , BH1750_SET_FILTER_EN				// Bit #22 'FILTER_EN' -> DIS/ENA
  , BH1750_SET_FILTER_THRES			// Bit #23 'FILTER_THRES' -> decval 10 bit zahl
  , BH1750_SET_CNT_THRES1				// Bit #24 'CNT_THRES1' -> decval 16 bit zahl
  , BH1750_SET_CNT_THRES0				// Bit #25 'CNT_THRES0' -> decval 16 bit zahl
  , BH1750_SET_CNT_L_LIM				// Bit #26 'CNT_L_LIM' -> decval 10 bit zahl
  , BH1750_SET_CNT_H_LIM				// Bit #27 'CNT_H_LIM' -> decval 10 bit zahl

// end marker
  , BH1750_SET_IK_Number_of_keys			// Bit #27 MAX 64 IMPLEMENTED !
 ...
 */
enum BH1750_Readings {			// Bit #XX for debugging

   BH1750_R_DUTY		= (1<<0)	// Bit #00 'Duty'  -> 

  ,BH1750_R_RESOLUTION	= (1<<1)	// Bit #01 'Resolution' -> 

  ,BH1750_R_NAME		= (1<<2)	// Bit #02 'name' + caps + ufid -> 
 ...
 */
kvParseImplementedKeys_t BH1750_Set_ImplementedKeys[] = {
// |                                                          affected readings										              	|  CMD

// for usage 
   { BH1750_R_DUTY | BH1750_R_RESOLUTION															, "ON" }		// #00
  ,{ BH1750_R_DUTY | BH1750_R_RESOLUTION															, "OFF" }		// #01
  ,{ BH1750_R_DUTY | BH1750_R_RESOLUTION															, "MAX" }		// #02
  ,{ BH1750_R_DUTY | BH1750_R_RESOLUTION															, "MIN" }		// #03
  ,{ BH1750_R_DUTY | BH1750_R_RESOLUTION															, "VAL" }		// #04
  ,{ BH1750_R_DUTY | BH1750_R_RESOLUTION															, "DIM" }		// #05

  ,{ BH1750_R_DUTY | BH1750_R_RESOLUTION | BH1750_R_NAME												, "NAME" }		// #06
  ,{ BH1750_R_DUTY | BH1750_R_RESOLUTION | BH1750_R_NAME												, "CAPS" }		// #07
...
/**
 * -------------------------------------------------------------------------------------------------
 *  DName: BH1750_ActiveResourcesDataA_forWebIf
...
const WebIf_ActiveResourcesDataA_t BH1750_ActiveResourcesDataA_forWebIf[] = {  //ICACHE_RODATA_ATTR = 
...
/**
 * -------------------------------------------------------------------------------------------------
 *  DName: BH1750_ActiveResourcesDataB_forWebIf
...
const WebIf_ActiveResourcesDataB_t BH1750_ActiveResourcesDataB_forWebIf[] =  {  //ICACHE_RODATA_ATTR =
 ...
 * -------------------------------------------------------------------------------------------------
 *  DName: BH1750_Module
 *  Desc: Data 'Provided By Module' for the BH1750 module (functions + infos this module 
 *        provides to SCDE)
 *  Data: 
 * -------------------------------------------------------------------------------------------------
 */
ProvidedByModule_t BH1750_ProvidedByModule = {   // A-Z order
  "BH1750"				// Type-Name of module -> on Linux libfilename.so !
  ,6					// size of Type-Name

  ,NULL					// Add
  ,BH1750_Attribute			// Attribute
  ,BH1750_Define			// Define
  ,NULL					// Delete
  ,NULL					// DirectRead
  ,NULL					// DirectWrite
  ,NULL					// Except
  ,NULL					// Get
  ,BH1750_IdleCb			// IdleCb
  ,BH1750_Initialize			// Initialize
  ,NULL					// Notify
  ,NULL					// Parse
  ,NULL					// Read
  ,NULL					// Ready
  ,NULL					// Rename
  ,BH1750_Set				// Set
  ,BH1750_Shutdown			// Shutdown
  ,NULL					// State
  ,NULL					// Sub
  ,BH1750_Undefine			// Undefine
  ,NULL					// Write
  ,NULL					// FnProvided
  ,sizeof(BH1750_Definition_t)		// Modul specific Size (Common_Definition_t + X)
};
...
BH1750_Attribute(Common_Definition_t* p_entry_definition,
	 const String_t attr_command,
	 const String_t attr_name,
	 const String_t attr_value)
{
  // make common ptr to modul specific ptr
  BH1750_Definition_t* p_entry_bh1750_definition =
		  (BH1750_Definition_t*) p_entry_definition;
...
// -------------------------------------------------------------------------------------------------
  ...
  #if BH1750_Module_DBG >= 5
  SCDEFn_at_BH1750_M->Log3Fn(p_entry_bh1750_definition->common.name,
	p_entry_bh1750_definition->common.nameLen,
	5,
	"Attribute Fn (Module '%.*s') is called with args: "
	"attr_command '%.*s' attr_name '%.*s' attr_value '%.*s'",
	p_entry_bh1750_definition->common.module->provided->typeNameLen,
	p_entry_bh1750_definition->common.module->provided->typeName,attr_command.len,
	attr_command.p_char,
  	attr_name.len,
	attr_name.p_char,
	attr_value.len,
 ...
 */
strTextMultiple_t*
BH1750_Define(Common_Definition_t *Common_Definition)
{
  // for Fn response msg
  strTextMultiple_t *retMsg = NULL;

  // make common ptr to modul specific ptr
  BH1750_Definition_t* BH1750_Definition =
		  (BH1750_Definition_t*) Common_Definition;

// -------------------------------------------------------------------------------------------------

  #if BH1750_Module_DBG >= 5
  SCDEFn_at_BH1750_M->Log3Fn(Common_Definition->name
	,Common_Definition->nameLen
	,5
	,"DefineFn of Module '%.*s' is called to continue creation of Definition '%.*s' with args '%.*s'."
	,BH1750_Definition->common.module->provided->typeNameLen
	,BH1750_Definition->common.module->provided->typeName
	,BH1750_Definition->common.nameLen
	,BH1750_Definition->common.name
	,BH1750_Definition->common.definitionLen
	,BH1750_Definition->common.definition);
  #endif
...
//	&ESP32Control_Definition->WebIf_Provided;
  ...
  BH1750_Definition->WebIf_Provided.WebIf_FnProvided =
	NULL;//(WebIf_FnProvided_t *) SCDEFn_at_BH1750_M->GetFnprovided("WebIf");

 // Providing data for WebIf? Initialise data provided for WebIf
  if (BH1750_Definition->WebIf_Provided.WebIf_FnProvided) {

	BH1750_Definition->WebIf_Provided.ActiveResourcesDataA =
		(WebIf_ActiveResourcesDataA_t *) &BH1750_ActiveResourcesDataA_forWebIf;

	BH1750_Definition->WebIf_Provided.ActiveResourcesDataB =
		(WebIf_ActiveResourcesDataB_t *) &BH1750_ActiveResourcesDataB_forWebIf;
...
// ------------------------------------------------------------------------------------------------
  ...
  parsedKVInputArgs_t *parsedKVInput = 
	SCDEFn_at_BH1750_M->ParseKVInputArgsFn(BH1750_SET_IK_Number_of_keys	// Num Implementated KEYs MAX
	,BH1750_Set_ImplementedKeys				// Implementated Keys
...
// ------------------------------------------------------------------------------------------------
  ...
  parsedKVInput->requiredKVBF = ( (1 << BH1750_SET_GPIO)
			        | (1 << BH1750_SET_BLOCK)
			        | (1 << BH1750_SET_CHANNEL)
			        | (1 << BH1750_SET_TIMER)
			        | (1 << BH1750_SET_DUTY)
			        | (1 << BH1750_SET_HPOINT)
			        | (1 << BH1750_SET_SIG_OUT_EN)
			        | (1 << BH1750_SET_IDLE_LV)
			        | (1 << BH1750_SET_RESOLUTION)
			        | (1 << BH1750_SET_TICK_SOURCE)
			        | (1 << BH1750_SET_FREQ_HZ) );
...
/*
  ...
  if (BH1750_ProcessKVInputArgs(BH1750_Definition
...
// ------------------------------------------------------------------------------------------------
 ...
 // BH1750_SetAffectedReadings(BH1750_Definition
...
//play here
  ...
  // temp build 'ESP32_I2C_Master'
	BH1750_Definition->stage1definitionNameLen = 
		asprintf(&BH1750_Definition->stage1definitionName,"I2CM");
/*
  ...
  ESP32_I2C_Master_Definition_Stage1 = SCDEFn_at_BH1750_M->GetDefinitionPtrByNameFn(
		 BH1750_Definition->stage1definitionNameLen
		,BH1750_Definition->stage1definitionName);
*/

  // make common ptr to modul specific ptr
  ESP32_I2C_Master_Definition_t* ESP32_I2C_Master_Definition =
		  (ESP32_I2C_Master_Definition_t*) SCDEFn_at_BH1750_M->GetDefinitionPtrByNameFn(
		 BH1750_Definition->stage1definitionNameLen
		,BH1750_Definition->stage1definitionName);
...
//        ret = i2c_master_sensor_test( I2C_MASTER_NUM, &sensor_data_h, &sensor_data_l);
    ...
    ESP32_I2C_Master_Fn->i2c_master_write_byteFn(cmd, BH1750_SENSOR_ADDR << 1 | WRITE_BIT, ACK_CHECK_EN);
    // append to linked list: write master cmd with cmd.op_code = I2C_CMD_WRITE and the byte
    ESP32_I2C_Master_Fn->i2c_master_write_byteFn(cmd, BH1750_CMD_START, ACK_CHECK_EN);
    // append to linked list: final stop cmd with cmd.op_code = I2C_CMD_STOP 
    ESP32_I2C_Master_Fn->i2c_master_stopFn(cmd);
/*
    // exec linked list!
    ret = ESP32_I2C_Master_Fn->i2c_master_cmd_beginFn(ESP32_I2C_Master_Definition->i2c_obj,
	cmd, 1000 / portTICK_RATE_MS);
    // loops through the linked list cmd elements, frees them + finally frees the linked list head too
    ESP32_I2C_Master_Fn->i2c_cmd_link_deleteFn(cmd);
  ...
  if (retMsg) {
	...
	ESP32_I2C_Master_Fn->i2c_master_startFn(cmd);
	ESP32_I2C_Master_Fn->i2c_master_write_byteFn(cmd, BH1750_SENSOR_ADDR << 1 | READ_BIT, ACK_CHECK_EN);
	ESP32_I2C_Master_Fn->i2c_master_read_byteFn(cmd, &sensor_data_h, ACK_VAL);
	ESP32_I2C_Master_Fn->i2c_master_read_byteFn(cmd, &sensor_data_l, NACK_VAL);
	ESP32_I2C_Master_Fn->i2c_master_stopFn(cmd);
/*
    ret = ESP32_I2C_Master_Fn->i2c_master_cmd_beginFn(ESP32_I2C_Master_Definition->i2c_obj,
		 cmd, 1000 / portTICK_RATE_MS);
...
// ------------------------------------------------------------------------------------------------
  ...
  BH1750_Definition->common.Common_CtrlRegA |= F_WANTS_IDLE_TASK;
 ...
 */
int
BH1750_IdleCb(Common_Definition_t *Common_Definition)
{
 ...
 */
int 
BH1750_Initialize(SCDERoot_t* SCDERootptr)
{

  // make data root locally available
  SCDERoot_at_BH1750_M = SCDERootptr;

  // make locally available from data-root: SCDEFn (Functions / callbacks) for faster operation
  SCDEFn_at_BH1750_M = SCDERootptr->SCDEFn;

  SCDEFn_at_BH1750_M->Log3Fn(BH1750_ProvidedByModule.typeName
		  ,BH1750_ProvidedByModule.typeNameLen
		  ,3
		  ,"InitializeFn called. Type '%.*s' now useable.\n"
		  ,BH1750_ProvidedByModule.typeNameLen
		  ,BH1750_ProvidedByModule.typeName);
...
BH1750_Set(Common_Definition_t* Common_Definition
	,uint8_t *setArgsText
...
// ------------------------------------------------------------------------------------------------
  ...
  parsedKVInputArgs_t *parsedKVInput = 
	SCDEFn_at_BH1750_M->ParseKVInputArgsFn(BH1750_SET_IK_Number_of_keys	// Num Implementated KEYs MAX for Set Fn
	,BH1750_Set_ImplementedKeys		// Implementated Keys for Set Fn
...
// ------------------------------------------------------------------------------------------------
  ...
  // set forbidden Keys -> Keys that are not allowed in this request
//  parsedKVInput->forbiddenKVBF = ( (1 << BH1750_SET_CNT_UNIT) );
  parsedKVInput->forbiddenKVBF = 0;
...
/**
 * --------------------------------------------------------------------------------------------------
 *  FName: BH1750_Shutdown
 *  Desc: called after 
 *  Info: Invoked by cmd-line 'Undefine BH1750_Definition.common.Name'
 *  Para: BH1750_Definition_t *BH1750_Definition -> WebIF Definition that should be removed
 *  Rets: strTextMultiple_t* -> response text NULL=no text
 * --------------------------------------------------------------------------------------------------
 */
strTextMultiple_t* ICACHE_FLASH_ATTR
BH1750_Shutdown(Common_Definition_t *Common_Definition)
{
 ...
 */
strTextMultiple_t* ICACHE_FLASH_ATTR
BH1750_Undefine(Common_Definition_t *Common_Definition)
{
...
/**
 * -------------------------------------------------------------------------------------------------
 *  FName: BH1750_ProcessKVInputArgs
 ...
 *  Para: BH1750_Definition_t *BH1750_Definition -> Definition that should get the input
...
BH1750_ProcessKVInputArgs(BH1750_Definition_t *BH1750_Definition
	,parsedKVInputArgs_t *parsedKVInput
	,uint8_t *argsText
	,size_t argsTextLen)
{
...
/*
  ...
  uint8_t newBlock = BH1750_Definition->Block;

  // block #2 get current assigned PWM Channel
  uint8_t newChannel = BH1750_Definition->Channel;

  // block #3 get current assigned PWM Timer
  uint8_t newTimer = BH1750_Definition->Timer;
*/
// ------------------------------------------------------------------------------------------------
  /*
  ...
  if (parsedKVInput->keysFoundBF & ( (uint64_t) 1 << BH1750_SET_BLOCK) ) {

	// valid input happened ?
	if (SCDEH_GetQueryKeyID((uint8_t*) argsText + parsedKVInput->keyData_t[BH1750_SET_BLOCK].off
		,parsedKVInput->keyData_t[BH1750_SET_BLOCK].len, &newBlock, BH1750_PWM_BLOCK)
		&& (newBlock <= 1) ) {
*/
/*
...
/*
  if (parsedKVInput->keysFoundBF & ( (uint64_t) 1 << BH1750_SET_CHANNEL) ) {

	// valid input happened ?
	if (SCDEH_GetDecUInt8Val((uint8_t*) argsText + parsedKVInput->keyData_t[BH1750_SET_CHANNEL].off
		,parsedKVInput->keyData_t[BH1750_SET_CHANNEL].len, &newChannel) 
		&& (newChannel <= 7) ) {
*/
/*
...
/*  
  ...
  if (parsedKVInput->keysFoundBF & ( (uint64_t) 1 << BH1750_SET_TIMER) ) {

	// valid input happened ?
	if (SCDEH_GetDecUInt8Val((uint8_t*) argsText + parsedKVInput->keyData_t[BH1750_SET_TIMER].off
		,parsedKVInput->keyData_t[BH1750_SET_TIMER].len, &newTimer) 
		&& (newTimer <= 3) ) {
*/
/*
...
/*
  ...
  uint8_t newGPIO = BH1750_Definition->GPIO;
...
/*
  ...
  if (parsedKVInput->keysFoundBF & ( (uint64_t) 1 << BH1750_SET_ATT) ) {
...
//>Caps Bit 1,2,3,4,5,6-----------------------------------------------------------------------------
  ...
  if (parsedKVInput->keysFoundBF & ( (uint64_t) 1 << BH1750_SET_AVU) ) {
...
//>Caps Bit 1---------------------------------------------------------------------------------------
  ...
  if (parsedKVInput->keysFoundBF & ( (uint64_t) 1 << BH1750_SET_AVF) ) {
...
//--------------------------------------------------------------------------------------------------
  ...
  if (parsedKVInput->keysFoundBF & ( (uint64_t) 1 << BH1750_SET_ATU) ) {
...
//>Caps Bit 2---------------------------------------------------------------------------------------
  ...
  if (parsedKVInput->keysFoundBF & ( (uint64_t) 1 << BH1750_SET_ATF) ) {
...
/*
  ...
  if (parsedKVInput->keysFoundBF & ( (uint64_t) 1 << BH1750_SET_CH1_LCTRL_MODE) ) {

	uint8_t newMode;

	// valid input happened ?
	if (SCDEH_GetQueryKeyID((uint8_t*) argsText + parsedKVInput->keyData_t[BH1750_SET_CH1_LCTRL_MODE].off
		,parsedKVInput->keyData_t[BH1750_SET_CH1_LCTRL_MODE].len, &newMode, &BH1750_CTRL_MODE)
		&& (newMode <= 3) ) {

		// store the value to temp
		BH1750_CNT_CONF_REG.CNT_CH1_LCTRL_MODE = newMode;
...
/*
  ...
  // -> ?? Setzt den Hardware-Counter des ESP32 (0-7) der verwendet werden soll
  // -> ?? Sets the hardware counter of the ESP32 (0-7) that should be used
  if (parsedKVInput->keysFoundBF & ( (uint64_t) 1 << BH1750_SET_CH1_HCTRL_MODE) ) {

	uint8_t NewMode;

	// valid input happened ?
	if (SCDEH_GetQueryKeyID((uint8_t*) argsText + parsedKVInput->keyData_t[BH1750_SET_CH1_HCTRL_MODE].off
		,parsedKVInput->keyData_t[BH1750_SET_CH1_HCTRL_MODE].len, &NewMode, BH1750_CTRL_MODE) ) {
...
/*
  ...
  // -> ?? Setzt den Hardware-Counter des ESP32 (0-7) der verwendet werden soll
  // -> ?? Sets the hardware counter of the ESP32 (0-7) that should be used
  if (parsedKVInput->keysFoundBF & ( (uint64_t) 1 << BH1750_SET_CH1_POS_MODE) ) {

	uint8_t NewMode;

	// valid input happened ?
	if (SCDEH_GetQueryKeyID((uint8_t*) argsText + parsedKVInput->keyData_t[BH1750_SET_CH1_POS_MODE].off
		,parsedKVInput->keyData_t[BH1750_SET_CH1_POS_MODE].len, &NewMode, BH1750_CH_MODE) ) {

		// store ne value
		BH1750_CNT_CONF_REG.CNT_CH1_POS_MODE = NewMode;
...
/*
  ...
  if (parsedKVInput->keysFoundBF | ( (1 << BH1750_SET_BLOCK) ) ) {
	...
	BH1750_Definition->Block = newBlock;
  }

  // block #2 store assigned PWM Channel
  if (parsedKVInput->keysFoundBF | ( (1 << BH1750_SET_CHANNEL) ) ) {
	...
	BH1750_Definition->Channel = newChannel;
  }

  // block #3 store assigned PWM Timer
  if (parsedKVInput->keysFoundBF | ( (1 << BH1750_SET_TIMER) ) ) {
	...
	BH1750_Definition->Timer = newTimer;
  }

  // block #4 store assigned / connected GPIO
  if (parsedKVInput->keysFoundBF | ( (1 << BH1750_SET_GPIO) ) ) {
	...
	// store assigned GPIO
	BH1750_Definition->GPIO = newGPIO;
  ...
  if (parsedKVInput->keysFoundBF & ( (1 << BH1750_SET_TIMER)
	...
	SCDEFn_at_BH1750_M->HexDumpOutFn ("dump"
		,pPWM_Channel
...
/**
 * ------------------------------------------------------------------------------------------------
 *  FName: BH1750_SetAffectedReadings
 ...
 */
bool ICACHE_FLASH_ATTR
BH1750_SetAffectedReadings(BH1750_Definition_t* BH1750_Definition
...
/*
 affectedReadings = 0xfffffffffffffff;
  ...
  SCDEFn_at_BH1750_M->readingsBeginUpdateFn((Common_Definition_t*) BH1750_Definition);
...
// -----------------------------------------------------------------------------------------------
  ...
  // pointer to make the hardware counters accessible
  ESP32_PWM_Channel_t *pPWM_Channel =
	(ESP32_PWM_Channel_t*) (0x3FF59000 + (0x14 * BH1750_Definition->Channel));
  // access low speed channels (instead of high speed channels)?
  if (BH1750_Definition->Block) pPWM_Channel =
	(ESP32_PWM_Channel_t*) ( (uint8_t*) pPWM_Channel + 0xa0);

  // pointer to make the hardware timers accessible
  ESP32_PWM_Timer_t *pPWM_Timer =
	(ESP32_PWM_Timer_t*) (0x3FF59140 + (0x08 * BH1750_Definition->Timer));
  // access low speed timers (instead of high speed timers)?
  if (BH1750_Definition->Block) pPWM_Timer =
	(ESP32_PWM_Timer_t*) ( (uint8_t*) pPWM_Timer + 0x20);

//>Add Readings Bit 00 -----------------------------------------------------------------------------

  // add reading 'Duty'
  if (affectedReadings & BH1750_R_DUTY) {
	...
	SCDEFn_at_BH1750_M->readingsBulkUpdateFn((Common_Definition_t*) BH1750_Definition
		,readingNameText
		,readingNameTextLen
		,readingValueText
		,readingValueTextLen);
...
//>Add Readings Bit 01 -----------------------------------------------------------------------------
  ...
  if (affectedReadings & BH1750_R_RESOLUTION) {
...
//>Add Readings Bit 02 -----------------------------------------------------------------------------
/*
  if (affectedReadings & BH1750_R_AV01_AV05_AV15) {
...
/*
  ...
  if (affectedReadings & BH1750_R_AVF) {
	...
	readingValueTextLen = asprintf((char **) &readingValueText
		,"%d.%04d"
		,(int) BH1750_Definition->IB01_AverageFactor	
		,(int) ( (BH1750_Definition->IB01_AverageFactor -
		(int) BH1750_Definition->IB01_AverageFactor) * 10000) );
...
/*
  ...
  if (affectedReadings & BH1750_R_AVU) {
	...
	readingValueTextLen = asprintf((char **) &readingValueText
		,"%s"
		,BH1750_Definition->IB01_AverageUnit);
...
/*
  ...
  if (affectedReadings & BH1750_R_ATF) {
	...
	readingValueTextLen = asprintf((char **) &readingValueText
		,"%d.%04d"
		,(int) (BH1750_Definition->IB01_AlltimeTotalFactor)	
		,(int) ( (BH1750_Definition->IB01_AlltimeTotalFactor -
		(int) BH1750_Definition->IB01_AlltimeTotalFactor) * 10000) );
...
/*
  ...
  if (affectedReadings & BH1750_R_ATU) {
	...
	readingValueTextLen = asprintf((char **) &readingValueText
		,"%s"
		,BH1750_Definition->IB01_AlltimeTotalUnit);
...
/*
  ...
  if (affectedReadings & BH1750_R_DEB) {
	...
	readingValueTextLen = asprintf((char **) &readingValueText
		,"%u"
		,BH1750_Definition->IB01_Debounce);
...
//>Add Readings Bit 08 -----------------------------------------------------------------------------
/*
  if (affectedReadings & BH1750_R_name)
	{
...
//  SCDEFn->readingsEndUpdateFn((Common_Definition_t*) BH1750_Definition);
