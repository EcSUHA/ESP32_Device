 ...
 *        String_t data          -> data that should be written (characters in allocated mem + len) 
 *  Rets: Entry_String_t* -> response: ptr to an singly linked tail queue element with return
		       ...
		       String_t data)
{
  ...
  // for Fn response msg
  Entry_String_t *retMsg_Entry_String = SCDE_OK;
